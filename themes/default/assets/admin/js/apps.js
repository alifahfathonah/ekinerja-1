...
var BlankonApp = function(){
    ...
    return {
        ...
        handleBaseURL: function () {
            ...
            return baseUrl+"/SIMPEG_BAP/themes/default";
        },
        ...
        handleTypehead: function () {
            if($('.typeahead').length){
                var repos = new Bloodhound({
                    ...
                    prefetch: url1818+'dashboard/find_pegawai'
                });
                repos.initialize();
                $('.typeahead').typeahead(null, {
                    ...
                    templates: {
                        ...
                        suggestion: Handlebars.compile([
                            ...
                            '<span class="media-heading">NIP: {{nip}}</span>',
                            '<span class="media-text">{{nama}}</span>',
                            '</span>',
                            '</a>'
                        ].join(''))
                    }
                    ...
                    callPages("pegawai/pegawai_detil", "contentModalProfil", "id="+data.id+"");
                });
            }
        },
