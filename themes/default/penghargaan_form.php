<form id="form_penghargaans" enctype="multipart/form-data" class="form-horizontal form-bordered" method="POST" action="<?=base_url();?>profil/penghargaan_save" role="form">
    <div class="form-body">
