        ...
        <div class="col-md-12">
            <div class="panel rounded shadow">
                ...
                <div class="panel-search">
                    <div class="row">
                        <form id="filter_keg_bulanan">
                            <div class="col-md-6">
                                <select data-placeholder="Pilih Tahun" class="form-control input-sm chosen-opt" tabindex="2" name="tahun" onchange="filterSelected('verifikasi_kegBulanan');">
                                    <?php
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="Pilih Unit Kerja" class="form-control input-sm chosen-opt" tabindex="2" name="unit_kerja" onchange="filterSelected('verifikasi_kegBulanan');">
                ...
                <div class="panel-body">
                    <table id="verifikasi_kegBulanan" class="table table-responsive" width="100%">
                        <thead>
                            <tr>
                                <th>::</th>
                                <th>Bulan</th>
