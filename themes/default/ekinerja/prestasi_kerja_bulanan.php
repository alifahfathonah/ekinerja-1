...
<body>
	<?php
	    ...
	    $hitung_prilaku = ($rata_rata * 40) / 100;
	...
	<div class="content">
		<div style="border: 1px solid black;">
			...
			<div class="text-center" style="margin-top: 135px; font-weight: bold;">
				Jangka Waktu Penilaian <br> Bulan <?=bulan($bulan);?> Tahun <?=$tahun;?>
			</div>
			...
			<h2 class="text-center" style="margin-top: 240px; margin-bottom: 55px;">BADAN KEPEGAWAIAN DAERAH <br> BULAN <?=strtoupper(bulan($bulan));?> TAHUN <?=$tahun;?></h2>
		</div>
		...
		<table width="100%" style="border-collapse: collapse;">
	        ...
	        <tr>
	        	...
	        	<td class="text-center border_tbl"><?=$hitung_skp;?></td>
	        </tr>
	        <tr>
	        	<td rowspan="9" class="border_tbl">b. Perilaku Kerja</td>
	        	<td class="border_tbl">1) Orientasi Pelayanan</td>
	        	<td class="border_tbl text-center" width="12%"><?=$sql_nilai['orientasi'];?></td>
	        	<td class="border_tbl text-center" width="12%"><?=string_nilai($sql_nilai['orientasi']);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">2) Integritas</td>
	        	<td class="border_tbl text-center"><?=$sql_nilai['integritas'];?></td>
	        	<td class="border_tbl text-center"><?=string_nilai($sql_nilai['integritas']);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">3) Komitmen</td>
	        	<td class="border_tbl text-center"><?=$sql_nilai['komitmen'];?></td>
	        	<td class="border_tbl text-center"><?=string_nilai($sql_nilai['komitmen']);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">4) Disiplin</td>
	        	<td class="border_tbl text-center"><?=$sql_nilai['disiplin'];?></td>
	        	<td class="border_tbl text-center"><?=string_nilai($sql_nilai['disiplin']);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">5) Kerjasama</td>
	        	<td class="border_tbl text-center"><?=$sql_nilai['kerja_sama'];?></td>
	        	<td class="border_tbl text-center"><?=string_nilai($sql_nilai['kerja_sama']);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">6) Kepemimpinan</td>
	        	<td class="border_tbl text-center"><?=$sql_nilai['kepemimpinan'];?></td>
	        	<td class="border_tbl text-center"><?=string_nilai($sql_nilai['kepemimpinan']);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">Jumlah</td>
	        	<td class="border_tbl text-center"><?=$hasil;?></td>
	        	<td class="border_tbl"></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">Nilai Rata-Rata</td>
	        	<td class="border_tbl text-center"><?=$rata_rata;?></td>
	        	<td class="border_tbl text-center"><?=string_nilai($rata_rata);?></td>
	        	<td class="border_tbl"></td>
	        </tr>
	        <tr>
	        	<td class="border_tbl">Nilai Perilaku Kerja</td>
	        	<td class="text-center" colspan="2"><?=$rata_rata;?> x 40%</td>
	        	<td class="border_tbl text-center"><?=$hitung_prilaku;?></td>
	        </tr>
	        <tr>
