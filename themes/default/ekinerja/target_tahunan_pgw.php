<div class="header-content">
    <h2><i class="fa fa-check-square-o"></i>Target Kinerja Tahunan Bawahan</h2>
    <div class="breadcrumb-wrapper hidden-xs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="javascript:void(0);">Target Kinerja Tahunan Bawahan</a>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="panel rounded shadow">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h3 class="panel-title">Target Kinerja Tahunan Bawahan</h3>
                    </div>
                ...
                <div class="panel-search">
                    <div class="row">
                        <form id="filter_keg_tahunan">
                            <div class="col-md-6">
                                <select data-placeholder="Pilih Tahun" class="form-control input-sm chosen-opt" tabindex="2" name="tahun" onchange="filterSelected('ekin_kegTahunanVerify');">
                                    <?php
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="Pilih Pegawai" class="form-control input-sm chosen-opt" tabindex="2" name="pegawai" onchange="filterSelected('ekin_kegTahunanVerify');">
                ...
                <div class="panel-body">
                    <table id="ekin_kegTahunanVerify" class="table table-primary table-striped" width="100%">
                        <thead>
                            <tr>
