        ...
        <div class="col-md-12">
            <div class="panel rounded shadow">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <span data-toggle="tooltip" data-placement="top" data-original-title="Tambah Data">
                            <button class="btn btn-sm" data-toggle="modal" data-target="#modal_data" onclick="javascript:callPages('pegawai/pegawai_form', 'contentModal', '');open_modal('', 'Tambah Pegawai', 'modal-primary');"><i class="fa fa-plus"></i></button>
                        </span>
                ...
                <div class="panel-body">
                    <table id="table_pegawaiAdminDinas" class="table table-primary table-striped" width="100%">
                        <thead>
                            <tr>
